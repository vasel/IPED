...
public class ExtraProperties {
        ...
        public static final Property CONVERSATION_IS_OWNER_ADMIN = Property
                        .internalBoolean(CONVERSATION_PREFIX + "isOwnerAdmin");
        ...
        public static final Property CONVERSATION_MESSAGES_COUNT = Property
                        .internalInteger(CONVERSATION_PREFIX + "messagesCount");
        ...
        public static final Property MESSAGE_ATTACHMENT_COUNT = Property
                        .internalInteger(Message.MESSAGE_PREFIX + "AttachmentCount"); //$NON-NLS-1$
        ...
        public static final String FISCAL_DOCTYPE = "fiscal:docType"; // NFe or CTe
        public static final String FISCAL_REMET_CNPJ = "fiscal:remetCnpj";
        ...
        public static final List<String> COMMUNICATION_BASIC_PROPS = Arrays.asList(MESSAGE_SUBJECT, MESSAGE_BODY,
                        Message.MESSAGE_CC, Message.MESSAGE_BCC, Message.MESSAGE_RECIPIENT_ADDRESS,
                        MESSAGE_IS_ATTACHMENT,
